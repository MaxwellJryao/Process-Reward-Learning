...
if [ $USE_MEGATRON -eq 1 ]; then
    ...
    NVTE_FRAMEWORK=pytorch uv pip3 install --no-deps git+https://github.com/NVIDIA/TransformerEngine.git@v2.2.1
    uv pip3 install --no-deps git+https://github.com/NVIDIA/Megatron-LM.git@core_v0.12.2
fi
